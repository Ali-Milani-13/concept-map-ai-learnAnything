...
export default function AiInput({ onGenerate, isGenerating, hasMap, theme, progress }: AiInputProps) {
  ...
  // FIX 1: Added pointer-events-none to the wrapper so it doesn't block map touches,
  // and changed top-6 to top-24 on mobile so it doesn't hit the top bar.
  ...
  return (
    <div className={containerClasses}>
      ...
      {/* FIX 2: Added pointer-events-auto directly to the form so ONLY the input is clickable */}
